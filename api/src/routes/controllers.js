...
const recipesUrl = `https://api.spoonacular.com/recipes/complexSearch?apiKey=${API_KEY1}&addRecipeInformation=true&number=10`;
...
const getRecipeInformation = async (ID) => {
    ...
    return await fetch(`https://api.spoonacular.com/recipes/${ID}/information?apiKey=${API_KEY1}`)
        .then(response => response.json())
